...
const std::map<std::string, std::string> kPageClassifierIds = {
    {"en", "djcjjghgcjchoepkmgnlijcgbipfgoab"},
    {"de", "hbddgbcknmoiiigambdgbkpamfnfenio"},
    {"fr", "jjldnoembnbdldpcbkaeolmdmpcmbebg"}
};
